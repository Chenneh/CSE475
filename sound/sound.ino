...
uint16_t volume = 127;
uint16_t ledcount = 0;
// string states[7] = {"ambinet #1", "ambinet #2", "ambient #3", "active #1", "active #2", "active #3", "startle #1"};
//char *s1 = "ambient #1";
//char *s2 =
char* states[7] = {"ambinet #1", "ambinet #2", "ambient #3", "active #1", "active #2", "active #3", "startle #1"};
/************ Radio Setup ***************/
...
uint8_t gesture[7][98] = {
  // ambinet #1 waltz for Debby
  {1,11,
  127,89,100,  127,82,100,  127,88,100,  127,81,100,
  127,86,100,  127,86,50,  127,84,50,  127,82,50,
  127,84,50,   127,86,50,  127,88,50},

  // ambinet #2 bach air
  {3,7,
  x,83,150, x,77,150, x,76,150, x,81,150, x,80,150, x,86,150, x,84,150},

  // ambient #3
  {1,6,
    x,57,600, x,61,600, x,64,600, x,69,600, x,61,600, x,64,600},

  // active #1 glass work
  {3,32,
  127,82,30, 127,85,30,  127,82,30, 127,85,30,  127,82,30, 127,85,30,  127,82,30, 127,85,30,
  127,89,30, 127,82,30,  127,89,30, 127,82,30,  127,89,30, 127,82,30,  127,89,30, 127,82,30,
  127,84,30, 127,89,30,  127,84,30, 127,89,30,  127,84,30, 127,89,30,  127,84,30, 127,89,30,
  127,85,30, 127,89,30,  127,85,30, 127,89,30,  127,85,30, 127,89,30,  127,85,30, 127,89,30},
  ...
  // active #3 halloweens
  {1,20,
  127,78,40,  127,71,40,  127,71,40,  127,78,40,
  127,71,40,  127,71,40,  127,78,40,  127,71,40,
  127,79,40,  127,71,40,  127,78,40,  127,71,40,
  127,71,40,  127,78,40,  127,71,40,  127,71,40,
  127,78,40,  127,71,40,  127,79,40,  127,71,20},

  // startle #1 toccata
  {3,9,
  127,86,25, 127,84,25,  127,86,100, 127,84,30,  127,82,30, 127,81,30,  127,79,30, 127,78,80, 127,79,50},
};
